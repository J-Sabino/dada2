...
seqtabB3AL1 <- readRDS("~/dada2/stringent/Batch3A_Lane1/Batch3A_Lane1_seqtab.rds")
...
seqtabB3AL2 <- readRDS("~/dada2/stringent/Batch3A_Lane2/Batch3A_Lane2_seqtab.rds")
...
seqtabB3BL1 <- readRDS("~/dada2/stringent/Batch3B_Lane1/Batch3B_Lane1_seqtab.rds")
...
saveRDS(st.all, "~/dada2/stringent/seqtab_Batch3_stringent_all.rds")

# Remove chimeras
seqtab_nochim <- removeBimeraDenovo(st.all, method="consensus", multithread=TRUE)
saveRDS(seqtab_nochim, "~/dada2/stringent/seqtab_Batch3_all_stringent_nochim.rds")

# Assign taxonomy
taxa <- assignTaxonomy(seqtab_nochim, "~/bin/silva_nr_v132_train_set.fa.gz", multithread=TRUE)
saveRDS(taxa, "~/dada2/stringent/tax_Batch3_stringent_final.rds")

taxa <- addSpecies(taxa, "~/bin/silva_species_assignment_v132.fa.gz")
saveRDS(taxa, "~/dada2/stringent/tax_Batch3_final_stringent_species.rds")
